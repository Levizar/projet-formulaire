...
include 'assets/php/header.php';?>
    ...
    <div class="jumbotron container justify-content-center text-center p-4 mt-3 col-10 shadow">
            <img src="assets/img/hackers-poulette-logo.png" alt="logo" class="img-fluid mb-3">
